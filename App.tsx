...
const App: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const storedPdfContent = localStorage.getItem('pdfContent');
        const storedPdfFileName = localStorage.getItem('pdfFileName');
        if (storedPdfContent && storedPdfFileName) {
            setPdfContent(storedPdfContent);
            setPdfFileName(storedPdfFileName);
        }
    ...
    const handlePdfUploaded = (content: string, fileName: string) => {
        setPdfContent(content);
        setPdfFileName(fileName);
        localStorage.setItem('pdfContent', content);
    ...
    const allData = {
        ...
        referenceAnalysis, projectProposal, projectEvaluation, workPlan, pdfContent
    };
